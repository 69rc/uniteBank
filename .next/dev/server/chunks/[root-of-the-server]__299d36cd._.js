...
"[project]/Documents/uniteBank/app/api/admin/transfers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const transfers = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$server$2f$admin$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminStorage"].getAllPendingTransfers();
        // Enrich with sender and recipient details
        const enrichedTransfers = await Promise.all(transfers.map(async (t)=>{
            const sender = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$server$2f$admin$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminStorage"].getUserByUuid(t.senderId);
            const recipient = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$server$2f$admin$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminStorage"].getUserByUuid(t.recipientId);
            return {
                ...t,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__299d36cd._.js.map