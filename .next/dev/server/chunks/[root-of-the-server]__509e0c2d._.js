...
"[project]/Documents/uniteBank/app/api/admin/users/[id]/approve/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    user = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$server$2f$admin$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminStorage"].updateUserStatusByUuid(idParam, "APPROVED");
    // If not found by UUID, try customer ID
    if (!user) {
        console.log("No user found by UUID, trying customer ID:", idParam);
        const foundUser = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$server$2f$admin$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminStorage"].getUserByCustomerId(idParam);
        if (foundUser) {
            console.log("Found user by customer ID, updating status for DB ID:", foundUser.id);
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$server$2f$admin$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminStorage"].updateUserStatusByUuid(foundUser.id, "APPROVED");
        } else {
    ...
    if (!user.accountNumber) {
        const accNum = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$app$2f$api$2f$utils$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateAccountNumber"])();
        await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$uniteBank$2f$server$2f$admin$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminStorage"].updateUserAccountNumber(user.id, accNum);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__509e0c2d._.js.map